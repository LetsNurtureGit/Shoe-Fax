...
+ (MFSideMenuContainerViewController *)containerWithCenterViewController:(id)centerViewController
    ...
    MFSideMenuContainerViewController *controller = [[MFSideMenuContainerViewController new] autorelease];
...
- (void)setDefaultSettings
{
    ...
    self.menuContainerView = [[[UIView alloc] init] autorelease];
...
- (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation {
    if(self.centerViewController)
        return [self.centerViewController shouldAutorotateToInterfaceOrientation:toInterfaceOrientation];
    return YES;
}
...
- (void)addGestureRecognizers {
  ...
  //  UITapUITapGestureRecognizer *tapRecognizer = [[UITapGestureRecognizer alloc]
//                                             initWithTarget:self
//                                             action:@selector(centerViewControllerTapped:)];
//    UISwipeGestureRecognizer *recognizer = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(centerViewControllerTapped:)];
